...
const PlanCard = () => {
  ...
  return (
    ...
    <div class="plan-card ml-4">
        <h2>Xcelero<span>Basic services</span></h2>
        ...
        <div className="button-get-plan">
            <a href="#">
                ...
                <span>Consult Price</span>
            </a>
            </div>
        </div>
        <br/>
    <div className="plan-card" style={{position:'relative', left:'-1rem',}}>
    <h2>Xcelero<span>Pro services</span></h2>
